...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/dhammakaya/anumothanaboon)
...
1. Clone the [lineliffHBD](https://github.com/dhammakaya/anumothanaboon) GitHub repository.

    ```shell
    git clone https://github.com/dhammakaya/anumothanaboon.git
    ```
